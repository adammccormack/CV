...
| ---------------------------- | ----------------- | ----------------- |
| **Ancoris Client Projects**(Private repo) | Build, test, and maintain features for multinational clients using Agile methodology with the Development, QA, and Design Teams ahead of Sprint goals on a consistent basis. | TypeScript/JavaScript, NextJS/ReactJS, Strapi CMS, PostgreSQL, Google Cloud Platform (GCP) |
